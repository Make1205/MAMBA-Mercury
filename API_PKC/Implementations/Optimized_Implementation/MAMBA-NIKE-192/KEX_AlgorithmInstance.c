...
typedef struct { unsigned char st_buf[sizeof(nike_state)]; unsigned char ma[4000]; unsigned long long ma_len; int ready; } sta_t;
typedef struct { unsigned char mb[4000]; unsigned char ss[64]; unsigned long long mb_len; int ready; } stb_t;

static const nike_params* P(void){ return &NIKE_192; }
