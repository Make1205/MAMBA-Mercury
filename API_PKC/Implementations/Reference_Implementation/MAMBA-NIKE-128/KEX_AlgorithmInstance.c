...
unsigned long long kex_get_stb_len_bytes(){ return sizeof(state_b_t); }
...
int kex_init_b(unsigned char *pkb, unsigned long long *pkb_len_bytes,unsigned char *skb, unsigned long long *skb_len_bytes,unsigned char *stb, unsigned long long *stb_len_bytes){(void)pkb;(void)skb;(void)stb;*pkb_len_bytes=0;*skb_len_bytes=0;memset(stb,0,sizeof(state_b_t));*stb_len_bytes=sizeof(state_b_t);return 0;}
